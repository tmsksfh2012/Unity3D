...
public class GameManager : MonoBehaviour
{
    public class Player_Value
    {
        ...
        public void Get_Level_Hp() {
            ...
            if(Gold >= Level_Hp * 10) {
                ...
                GameManager.Instance.Text_Gold.text = 
                GameManager.Instance.Set_Text("HP UP!!");
            }
            else {
                GameManager.Instance.Set_Text("골드가 모자랍니다.");
            }
        }
        ...
        public void Get_Level_Damage() {
            if(Gold >= Level_Damage * 5) {
                ...
                GameManager.Instance.Set_Text("Damage UP!!");
            }
            else {
                GameManager.Instance.Set_Text("골드가 모자랍니다.");
            }
    ...
    public void Set_Text(string text) {
        ...
        if(!set) {
            Text t = Instantiate(Text_Damage, new UnityEngine.Vector2(Screen.width * 0.5f, Screen.height * 0.5f),
